...
# Insert grid_html after the closing of why-layout
# Look for <section class="trust-strip"> and insert before it
html = html.replace('<section class="trust-strip">', grid_html + '\n    <section class="trust-strip">')
...
# 2. Append to styles.css
css_append = """
/* Reorder Grid Component */
.reorder-stage {
    display: flex;
